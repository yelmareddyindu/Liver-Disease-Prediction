...
--
-- Database: `liver_disease_prediction`
--
CREATE DATABASE IF NOT EXISTS `liver_disease_prediction` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `liver_disease_prediction`;
...
('38z1obxstfv3f12tfggut74hrhfgdlmf', 'eyJ1c2VyaWQiOjF9:1oBviI:1oTiCr3sLU_13eWaV52z3b3VRp8TMF01wJrZgWD0tL8', '2022-07-28 10:04:54.094698'),
...
('8xycaqqs9u63wcuixdaldyq3mz7uavni', 'eyJ1c2VyaWQiOjF9:1oBwb5:Ah_bxiFVpgbT_hVElzkSlHd-6txsUHun64pQ4AEE7WE', '2022-07-28 11:01:31.184801'),
...
('rt0gpvhgw5dlw6ng9zpz91dzfbva6feg', 'eyJ1c2VyaWQiOjR9:1mqb7A:hdQ24oajhDxDq7k410-_qwfTwRN43bXbksgL-rFlS5s', '2021-12-10 13:18:08.895159'),
...
('vp0dy06w7ql7o4ac4ehgz1k81lqy38lm', 'eyJ1c2VyaWQiOjJ9:1mqasL:Nxa4stZtGg6xQspUE9x8hVi8bHVvfZW__dfjuz4XPN4', '2021-12-10 13:02:49.562089'),
...
(1, 'Kavin', 'Kavin123@gmail.com', 'Kavin', '9535866270', 'India', 'Karnataka', 'Bangalore');
...
(43, 'Naive Bayes', '30.76923076923077'),
(44, 'SVM', '74.35897435897436'),
(45, 'Decision Tree Classifier', '73.50427350427351');
...
(9, 'No Liver Disease', '50.0'),
(10, 'Foud Liver Disease', '50.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_disease_prediction`
--

CREATE TABLE IF NOT EXISTS `remote_user_disease_prediction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Pid` varchar(30000) NOT NULL,
  `Age` varchar(300) NOT NULL,
  `Gender` varchar(300) NOT NULL,
  `Total_Bilirubin` varchar(300) NOT NULL,
  `Direct_Bilirubin` varchar(300) NOT NULL,
  `Alkaline_Phosphotase` varchar(300) NOT NULL,
  `Alamine_Aminotransferase` varchar(300) NOT NULL,
  `Aspartate_Aminotransferase` varchar(300) NOT NULL,
  `Total_Protiens` varchar(300) NOT NULL,
  `Albumin` varchar(300) NOT NULL,
  `Albumin_and_Globulin_Ratio` varchar(300) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=4 ;

--
-- Dumping data for table `remote_user_disease_prediction`
--

INSERT INTO `remote_user_disease_prediction` (`id`, `Pid`, `Age`, `Gender`, `Total_Bilirubin`, `Direct_Bilirubin`, `Alkaline_Phosphotase`, `Alamine_Aminotransferase`, `Aspartate_Aminotransferase`, `Total_Protiens`, `Albumin`, `Albumin_and_Globulin_Ratio`, `Prediction`) VALUES
(1, 'd324b1ee-aaa1-4edb-9b46-c597cb0bbd8c', '26', 'Female', '0.9', '0.2', '154', '16', '12', '7', '3.5', '1', 'No Liver Disease'),
(3, '864e343b-1dea-449f-a021-aedb84c9815d', '46', 'Female', '14.2', '7.8', '374', '38', '77', '4.3', '2', '0.8', 'Foud Liver Disease');
