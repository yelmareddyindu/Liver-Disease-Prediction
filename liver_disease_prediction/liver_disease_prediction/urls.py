"""liver_disease_prediction URL Configuration
...
from liver_disease_prediction  import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Liver_Disease_Status/$', remoteuser.Predict_Liver_Disease_Status, name="Predict_Liver_Disease_Status"),
    ...
    url(r'^Find_Liver_Disease_Ratio/$', serviceprovider.Find_Liver_Disease_Ratio, name="Find_Liver_Disease_Ratio"),
    url(r'^Train_Test_DataSets/$', serviceprovider.Train_Test_DataSets, name="Train_Test_DataSets"),
    url(r'^View_Liver_Disease_Status/$', serviceprovider.View_Liver_Disease_Status, name="View_Liver_Disease_Status"),
